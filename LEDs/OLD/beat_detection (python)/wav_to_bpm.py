""" Main script that processes audio data
    - extract_bpm returns the BPM of a song
    - calculate_peaks returns the time stamps of the biggest beats in each song 
      for more accurate and meaningful audio-visual effect (e.g. this filters
      out redundant, inaudible beats that occur within the same second)
"""
